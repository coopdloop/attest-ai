module github.com/attest-ai/attestation_service

go 1.25

require (
	github.com/attest-ai/signing_service v0.0.0
...
replace github.com/attest-ai/signing_service => ../signing_service
